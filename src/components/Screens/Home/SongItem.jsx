...
const SongItem = ({ data }) => {
    ...
    return (
        <View style={tw`flex-row`}>
            <TouchableOpacity onPress={() => { setImageUrl(data.thumbnails[0].url), setSongName(data.name), setArtistName(data.artist.name),setYoutubeId(data.videoId),setDataType("musics")}}>
